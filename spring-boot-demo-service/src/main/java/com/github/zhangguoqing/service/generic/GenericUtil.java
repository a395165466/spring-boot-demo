package com.github.zhangguoqing.service.generic;

import com.github.zhangguoqing.service.Person;
...
public class GenericUtil {
    public static void test(ArrayList<String> list) {
        ...
        try {
            //Class
            Class clazz = Class.forName("com.github.zhangguoqing.service.Person");
            Person person = (Person)clazz.newInstance();
            System.out.println(person);

            //Class<?>
            Class<?> clazz1 = Class.forName("com.github.zhangguoqing.service.Person");
